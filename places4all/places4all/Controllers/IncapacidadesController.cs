...
namespace places4all.Controllers
{
    public class IncapacidadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IncapacidadeId,Designation")] Incapacidade incapacidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IncapacidadeId,Designation")] Incapacidade incapacidade)
        {
            if (ModelState.IsValid)
            {
