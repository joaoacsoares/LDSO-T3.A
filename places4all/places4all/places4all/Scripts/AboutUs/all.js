/*1447371297,,JIT Construction: v2041018,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d('sdk.Dialog', ['sdk.Canvas.Environment', 'sdk.Content', 'sdk.DOM', 'DOMEventListener', 'ObservableMixin', 'sdk.Runtime', 'Type', 'sdk.UA', 'sdk.fbt', 'sdk.feature'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    ...
                    var x = n.extend({
                        ...
                        y = {
                                ...
                                for (var aa in y._dialogs)
                                    if (y._dialogs.hasOwnProperty(aa)) {
                                        ...
                                        if (ba) {
                                            ...
                                            if (!z) ba.style.height = y.getDefaultSize().height + 'px';
                                        }
                                    }
                            },
                            ...
                            _scheduleHandleOrientationChange: function(z) {
                            ...
                            _addOrientationHandler: function() {
                                ...
                                k.add(window, z, y._scheduleHandleOrientationChange);
                            },
                            create: function(z) {
                                z = z || {};
                                var aa = document.createElement('div'),
                ...
                __d('sdk.UIServer', ['sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Dialog', 'sdk.Event', 'sdk.Frictionless', 'Log', 'sdk.Native', 'QueryString', 'sdk.RPC', 'sdk.Runtime', 'JSSDKConfig', 'sdk.UA', 'UrlMap', 'sdk.XD', 'createObjectFrom', 'sdk.feature', 'flattenObject', 'sdk.getContextType', 'guid', 'insertIframe', 'resolveURI'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba, ca) {
                    ...
                    var ia = {
                        ...
                        urlTooLongForIE: function(ja) {
                            return t.ie() && t.ie() <= 8 && ja.length > 2048;
                        },
                        ...
                        p = k.extend({
                            ...
                            parse: function(q) {
                                ...
                                for (var t = 1; t < q.length; t++)
                                    if (j.instanceOf(p, q[t])) q[t].hasDependency(true);
                                return this;
                            },
                            toFql: function() {
                                ...
                                switch (this.where.type) {
                                    ...
                                    case 'in':
                                        ...
                                        } else q += this.where.key + ' in (' + ES(this.where.value, 'map', true, n).join(',') + ')';
                                        break;
                                }
                                return q;
                            },
                ...
                __d('sdk.Data', ['sdk.api', 'sdk.ErrorHandling', 'mergeArrays', 'sdk.Query', 'safeEval', 'sdk.Waitable'], function a(b, c, d, e, f, g, h, i, j, k, l, m) {
                    ...
                    var n = {
                        query: function(o, p) {
                            var q = new k().parse(Array.prototype.slice.call(arguments));
                            n.queue.push(q);
                            n._waitToProcess();
                            return q;
                        },
                        ...
                        _process: function(o) {
                            ...
                            for (var u in p)
                                if (p.hasOwnProperty(u)) t.q[u] = p[u].toFql();
                            if (o) t.access_token = o;
                            h('/fql', 'GET', t, function(v) {
                                if (v.error) {
                                    ES(ES('Object', 'keys', false, p), 'forEach', true, function(w) {
                ...
                __d('sdk.init', ['sdk.Cookie', 'sdk.ErrorHandling', 'sdk.Event', 'Log', 'ManagedError', 'sdk.PlatformVersioning', 'QueryString', 'sdk.Runtime', 'sdk.URI', 'createArrayFromMixed', 'sdk.feature'], function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    ...
                    function t(u) {
                        ...
                        if (o.getIsVersioned()) {
                            ...
                            if (!u.version) u.version = new p(location.href).getQueryData().sdk_version;
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2041018","message":"' + e.message + '"}}');
}