(function() {
    ...
    var Lg = function() {
            var a;
            a = "";
            var b = '<div class="rc-footer"><div class="rc-separator"></div><div class="rc-controls" role="region" aria-label= "' + "controlos recaptcha".replace(Jg, Kg) + '"><div class="primary-controls"><div class="rc-buttons"><div class="button-holder reload-button-holder"></div><div class="button-holder audio-button-holder"></div><div class="button-holder image-button-holder"></div><div class="button-holder help-button-holder"></div></div><div class="verify-button-holder"></div><div style="clear:both"></div><div class="rc-report-problem-text">Comunicar um problema</div></div><div class="secondary-controls" style="display:none"><div class="report-captcha-button-holder"></div><div class="rc-separator"></div></div></div><div class="rc-challenge-help" style="display:none" tabIndex="0"></div>',
                c;
            c = R('<div class="rc-report-problem-section" style="display:none"><div class="rc-report-problem-header">Por que motivo est\u00e1 a denunciar este CAPTCHA?<div class="rc-report-close"></div></div><div class="rc-report-problem-options"></div></div>');
            a = R(a + (b + c + "</div>"));
            return Ag(a)
        },
        Mg = function(a) {
    ...
    var Dj = function(a) {
        ...
        yj = function(a) {
            a = "" + ('<div class="rc-anchor-aria-status"><section><h1>estado do recaptcha</h1><span id="recaptcha-accessible-status" aria-live="assertive" aria-atomic="true">' + Ag(a.rc) + "</span></section></div>");
            return R(a)
        },
        Bj = function() {
            return R('<div class="rc-inline-block"><div class="rc-anchor-center-container"><div class="rc-anchor-center-item rc-anchor-checkbox-holder"></div></div></div><div class="rc-inline-block"><div class="rc-anchor-center-container"><label class="rc-anchor-center-item rc-anchor-checkbox-label">N\u00e3o sou um rob\u00f4</label></div></div>')
        },
        zj = function() {
        ...
        Cj = function(a) {
            a = "" + ('<div class="rc-anchor-pt"><a href="https://www.google.com/intl/' + T(a.locale) + '/policies/privacy/" target="_blank">Privacidade</a> - <a href="https://www.google.com/intl/' +
                T(a.locale) + '/policies/terms/" target="_blank">Termos de Utiliza\u00e7\u00e3o</a></div>');
            return R(a)
        };
    ...
    var Ej = {
        ...
        Gj = {
            0: "Ocorreu um erro desconhecido. Experimente atualizar a p\u00e1gina.",
            1: "Erro: par\u00e2metro(s) da API inv\u00e1lido(s). Experimente atualizar a p\u00e1gina.",
            2: "A sess\u00e3o expirou. Atualize a p\u00e1gina."
        };
    Fj.prototype.B = function() {
        this.m = $e(Dj, {
            size: this.pa,
            Jg: this.Kg,
            rc: "\u00c9 necess\u00e1rio validar o reCAPTCHA",
            locale: "pt-PT"
        });
        this.ha(this.a())
    };
    ...
    f.Wf = function(a) {
        a.wk && (this.o.Ea.Ya(!0), Hj(this.o, !1), Ij(this.o, "Utilizador confirmado", !0), this.h = "checked", this.I.send("client", "update", a), hd(v(this.Kj, this, a.response), 1E3 * a.bk))
    };
    f.Qf = function(a) {
    ...
    f.Rf = function() {
        Ij(this.o, "O teste de valida\u00e7\u00e3o expirou. Volte a marcar a caixa de verifica\u00e7\u00e3o para realizar um novo teste", !0);
        this.h = "hidden";
        this.I.send("client", "show_challenge", new pi(!1))
    };
    f.vj = function() {
        "open" != this.h && "error" != this.h && (Ij(this.o, "A abrir teste de valida\u00e7\u00e3o"), this.o.Ea.ki(v(function() {
    ...
    var Lj = function(a) {
        ...
        Pj = function(a) {
            ...
            a.l.Ef && (b.chr = a.l.Ef);
            var c =
                new Ci(uj("api2/frame")),
                d = new Ki;
            d.extend(b);
            return new pi(!1, null, null, {
                src: Ii(c, d).toString(),
                title: "Desafio recaptcha"
            }, a.Re)
        };
    Jj.prototype.Kj = function(a) {
        "checked" == this.h && (Hj(this.o, !0, "A valida\u00e7\u00e3o expirou. Marque a caixa de verifica\u00e7\u00e3o novamente."), this.o.Ea.ji(), Ij(this.o, "A valida\u00e7\u00e3o expirou. Volte a marcar a caixa de verifica\u00e7\u00e3o para realizar um novo teste"), this.h = "hidden", this.I.send("client", "expiry"), this.I.send("challenge", "expiry", new qi(a)))
    };
    ...
    */
    ...
    var Al = function(a) {
        ...
        c = new gi(c, a, d);
        d = "";
        a.jd() && (a = Ti(uj("api2/webworker.js")), Si(a, "hl", "pt-PT"), Si(a, "v", "r20151104115408"), d = a.toString());
        a = new hl(d);
    ...
    var Ml = function() {
            var a;
            a = '<div class="rc-defaultchallenge-response-field"></div><div class="rc-defaultchallenge-payload"></div><div class="rc-defaultchallenge-incorrect-response" style="display:none">S\u00e3o necess\u00e1rias v\u00e1rias solu\u00e7\u00f5es corretas, pelo que ter\u00e1 de resolver mais.</div>' + Lg();
            return R(a)
        },
        Nl = function(a) {
            a = "" + ('<img src="' + T(Xg(a.xb)) + '" alt="' + "Imagem desafiante reCAPTCHA".replace(Jg, Kg) + '" />');
            return R(a)
        },
        Ol = function() {
            return R('Digite o seu melhor palpite do texto apresentado. Para obter um novo desafio, clique no \u00edcone de atualiza\u00e7\u00e3o. <a href="https://support.google.com/recaptcha" target="_blank">Saiba mais.</a>')
        };
    var Pl = function(a, b) {
        H.call(this);
        this.Bf = a || 0;
    ...
    var Y = function(a, b, c, d) {
        ...
        G(this, this.gf);
        this.rg = null;
        this.Xe = pm(this, "rc-button", void 0, "recaptcha-reload-button", "Ver um novo desafio", "rc-button-reload");
        this.ee = pm(this, "rc-button", void 0, "recaptcha-audio-button", "Ver um desafio \u00e1udio", "rc-button-audio");
        this.Ie = pm(this, "rc-button", void 0, "recaptcha-image-button", "Ver um desafio visual", "rc-button-image");
        this.Gh = pm(this,
            "rc-button", void 0, "recaptcha-help-button", "Ajuda", "rc-button-help", !0);
        this.vi = pm(this, void 0, "Confirmar", "recaptcha-verify-button", void 0, void 0, void 0);
        this.Ed = pm(this, void 0, "DENUNCIAR CAPTCHA", "recaptcha-report-captcha-button", void 0, "rc-report-captcha-button", void 0);
        this.Ed.Z(!1);
        this.se = new Wl(void 0, Yl.na());
        zf(this, this.se);
        this.Fd = new fm;
        G(this, this.Fd);
        this.ei = pm(this, "rc-button", void 0, void 0, "Fechar Comunicar um problema")
    };
    x(Y, O);
    var qm = {
            Jk: 0,
        ...
        rm = rb(qm.Rg, "Nenhuma solu\u00e7\u00e3o v\u00e1lida", qm.Sg, "Conte\u00fado de baixa qualidade", qm.sf, "Conte\u00fado pornogr\u00e1fico ou violento");
        ...
        "p" == a && Ac(function() {
            a: {
                ...
                if (!a.mb || "thanks" != a.mb.type) {
                    ...
                    a.Td.push(new Tl("", "Obrigado por ajudar a melhorar o reCAPTCHA!", 3E3, "thanks"));
                    a.mb || Sl(a)
                }
            }
        }, this);
    ...
    var Fm = function(a, b) {
        zm.call(this, t(a) ? a : "Escreva o texto", b)
    };
    x(Fm, zm);
    ...
    C && E("11");
    var Km = function(a) {
            a = "" + ('<span class="rc-audiochallenge-tabloop-begin" tabIndex="0"></span><div class="rc-audiochallenge-error-message" style="display:none" tabIndex="0"></div><div class="rc-audiochallenge-instructions" id="' + T(a.Ij) + '" tabIndex="0">Prima REPRODUZIR e introduza os n\u00fameros que ouvir</div><div class="rc-audiochallenge-control"></div><div class="rc-audiochallenge-response-field"></div><div class="rc-audiochallenge-download"></div>' + Lg() + '<span class="rc-audiochallenge-tabloop-end" tabIndex="0"></span>');
            return R(a)
        },
        Lm = function() {
        ...
        Nm = function(a) {
            a = "" + ('<a class="rc-audiochallenge-download-link" target="_blank" href="' + T(Vg(a.og)) + '" title="' + "Em alternativa, transfira o \u00e1udio como MP3".replace(Jg, Kg) + '"></a>');
            return R(a)
        },
        Om = function() {
            return R('Prima R para repetir o mesmo desafio. Prima o bot\u00e3o de atualiza\u00e7\u00e3o para obter um novo desafio. <a href="https://support.google.com/recaptcha/#6175971" target="_blank">Saiba como resolver este desafio.</a>')
        },
        Pm = function() {
            return R('Prima o bot\u00e3o de atualiza\u00e7\u00e3o para obter um novo desafio. <a href="https://support.google.com/recaptcha/#6175971" target="_blank">Saiba como resolver este desafio.</a>')
        };
    ...
    f.J = function() {
        ...
        if (this.la) {
            ...
            var a = this.H("rc-audiochallenge-play-button"),
                b = pm(this, void 0, "REPRODUZIR", void 0, void 0, void 0, void 0);
            G(this, b);
            wf(b, "audio-control");
            b.render(a);
        ...
        P(this).g(K("rc-audiochallenge-tabloop-begin"), "focus", function() {
            dn(!1)
        }).g(K("rc-audiochallenge-tabloop-end"),
            "focus",
            function() {
                dn(!0)
            });
    ...
    f.nk = function() {
        Lf(this.F.a(), "label", "Introduza os n\u00fameros que ouvir")
    };
    f.ek = function() {
    ...
    var fn = function(a, b) {
        ...
        Gm(a.F, b);
        be(a.Ra);
        b && je(a.Ra, "S\u00e3o necess\u00e1rias v\u00e1rias solu\u00e7\u00f5es corretas, pelo que ter\u00e1 de resolver mais.")
    };
    ...
    var mn = {
        "/m/0jbk": "animais",
        "/m/0bt9lr": "c\u00e3es",
        "/m/0gy7v": "porquinhos-da-\u00edndia",
        "/m/01yrx": "gatos",
        "/m/05s2s": "plantas",
        "/m/06m11": "rosas",
        "/m/06m11-red": "rosas vermelhas",
        "/m/06m11-pink": "rosas cor-de-rosa",
        "/m/0gqbt": "arbustos",
        "/m/01645p": "abacates",
        "/m/025_v": "catos",
        "/m/044plb": "catos barril",
        "/m/0m5w_": "catos saguaro",
        "/m/025rm5": "catos figo-da-\u00edndia",
        "/m/011s": "alimenta\u00e7\u00e3o ou bebidas",
        "/m/05yxcqj": "alimenta\u00e7\u00e3o",
        "/m/0fszt": "bolo",
        "/m/03p1r4": "queques",
        "/m/022p83": "bolos de casamento",
        "/m/02czv8": "bolos de anivers\u00e1rio",
        "/m/09728": "p\u00e3o",
        "/m/0l515": "sandu\u00edches",
        "/m/0cdn1": "hamb\u00fargueres",
        "/m/01j3zr": "burrito",
        "/m/07pbfj": "peixe",
        "/m/0cxn2": "gelado",
        "/m/05z55": "massa",
    ...
    var nn = function() {
        ...
        on = function(a) {
            ...
            switch (ga(d = a.label) ? d.toString() : d) {
                case "streetname":
                    e += "Selecione todas as imagens com <strong>nomes de rua</strong>.";
                    break;
                case "signs":
                    e += "Selecione todas as imagens com <strong>placas de sinaliza\u00e7\u00e3o</strong>.";
                    break;
                case "TileSelectionStreetSign":
                    e += "Selecione todos os quadrados com <strong>placas de sinaliza\u00e7\u00e3o</strong>.";
                    break;
                case "street_num":
                    e += "Selecione todas as imagens com <strong>n\u00fameros de rua</strong>.";
                    break;
                case "TileSelectionBizView":
                    e += "Selecione todos os quadrados com <strong>nomes de empresas</strong>.";
                    break;
                case "ImageSelectBizFront":
                    e += "Select all images with a <strong>business front</strong>.";
                    break;
                case "/m/02wbm":
                    e += "Selecione todos os <strong>alimentos</strong>.";
                    break;
                case "/m/0270h":
                    e += "Selecione todas as <strong>sobremesas</strong>.";
                    break;
                case "/m/0270h":
                    e += "Selecione todas as imagens que contenham algo que comeria ao pequeno-almo\u00e7o.";
                    break;
                case "/m/0fszt":
                    e += "Selecione todas as imagens com <strong>bolos</strong>.";
                    break;
                case "/m/03p1r4":
                    e += "Selecione todas as imagens com <strong>queques</strong>.";
                    break;
                case "/m/022p83":
                    e += "Selecione todas as imagens com <strong>bolos de casamento</strong>.";
                    break;
                case "/m/02czv8":
                    e += "Selecione todas as imagens com <strong>bolos de anivers\u00e1rio</strong>.";
                    break;
                case "/m/09728":
                    e += "Selecione todas as imagens com <strong>p\u00e3o</strong>.";
                    break;
                case "/m/0l515":
                    e += "Selecione todas as imagens com <strong>sandu\u00edches</strong>.";
                    break;
                case "/m/0cdn1":
                    e += "Selecione todas as imagens com <strong>hamb\u00fargueres</strong>.";
                    break;
                case "/m/01j3zr":
                    e += "Selecione todas as imagens com <strong>burritos</strong>.";
                    break;
                case "/m/07pbfj":
                    e += "Selecione todas as imagens com <strong>peixe</strong>.";
                    break;
                case "/m/0cxn2":
                    e += "Selecione todas as imagens com <strong>gelado</strong>.";
                    break;
                case "/m/05z55":
                    e += "Selecione todas as imagens com <strong>massa</strong>.";
                    break;
                case "/m/0grtl":
                    e += "Selecione todas as imagens com <strong>bife</strong>.";
                    break;
                case "/m/0663v":
                    e += "Selecione todas as imagens com <strong>piza</strong>.";
                    break;
                case "/m/01z1m1x":
                    e += "Selecione todas as imagens com <strong>sopa</strong>.";
                    break;
                case "/m/07030":
                    e +=
                        "Selecione todas as imagens com <strong>sushi</strong>.";
                    break;
                case "/m/09759":
                    e += "Selecione todas as imagens com <strong>arroz</strong>.";
                    break;
                case "/m/02y6n":
                    e += "Selecione todas as imagens com <strong>batatas fritas</strong>.";
                    break;
                case "/m/0mjqn":
                    e += "Selecione todas as imagens com <strong>tartes</strong>.";
                    break;
                case "/m/0jy4k":
                    e += "Selecione todas as imagens com <strong>donuts</strong>.";
                    break;
                case "/m/033cnk":
                    e += "Selecione todas as imagens com <strong>ovos</strong>.";
                    break;
                case "/m/0gm28":
                    e +=
                        "Selecione todas as imagens com <strong>doces</strong>.";
                    break;
                case "/m/0grw1":
                    e += "Selecione todas as imagens com <strong>salada</strong>.";
                    break;
                case "/m/0pmbh":
                    e += "Selecione todas as imagens com <strong>dim sum</strong>.";
                    break;
                case "/m/021mn":
                    e += "Selecione todas as imagens com <strong>bolachas</strong>.";
                    break;
                case "/m/01dwwc":
                    e += "Selecione todas as imagens com <strong>panquecas</strong>.";
                    break;
                case "/m/01dwsz":
                    e += "Selecione todas as imagens com <strong>waffles</strong>.";
                    break;
                case "/m/0fbw6":
                    e +=
                        "Selecione todas as imagens com <strong>couve</strong>.";
                    break;
                case "/m/09qck":
                    e += "Selecione todas as imagens com <strong>bananas</strong>.";
                    break;
                case "/m/047v4b":
                    e += "Selecione todas as imagens com <strong>alcachofras</strong>.";
                    break;
                case "/m/01b9xk":
                    e += "Selecione todas as imagens com <strong>cachorros-quentes</strong>.";
                    break;
                case "/m/0h0xm":
                    e += "Selecione todas as imagens com <strong>bacon</strong>.";
                    break;
                case "/m/0cyhj_":
                    e += "Selecione todas as imagens com uma <strong>laranja</strong>.";
                    break;
                case "/m/0fg0m":
                    e += "Selecione todas as imagens com <strong>amendoins</strong>.";
                    break;
                case "/m/04rx8j":
                    e += "Selecione todas as imagens com <strong>salada de frutas</strong>.";
                    break;
                case "/m/01hrv5":
                    e += "Selecione todas as imagens com <strong>pipocas</strong>.";
                    break;
                case "/m/05zsy":
                    e += "Selecione todas as imagens com <strong>ab\u00f3boras</strong>.";
                    break;
                case "/m/0271t":
                    e += "Selecione todas as <strong>bebidas</strong>.";
                    break;
                case "/m/01599":
                    e += "Selecione todas as imagens com <strong>cerveja</strong>.";
                    break;
                case "/m/081qc":
                    e += "Selecione todas as imagens com <strong>vinho</strong>.";
                    break;
                case "/m/02vqfm":
                    e += "Selecione todas as imagens com <strong>caf\u00e9</strong>.";
                    break;
                case "/m/07clx":
                    e += "Selecione todas as imagens com <strong>ch\u00e1</strong>.";
                    break;
                case "/m/01z1kdw":
                    e += "Selecione todas as imagens com <strong>sumo</strong>.";
                    break;
                case "/m/01k17j":
                    e += "Selecione todas as imagens com um <strong>batido de leite</strong>.";
                    break;
                case "/m/05s2s":
                    e += "Selecione todas as imagens com <strong>plantas</strong>.";
                    break;
                case "/m/0c9ph5":
                    e += "Selecione todas as imagens com <strong>flores</strong>.";
                    break;
                case "/m/07j7r":
                    e += "Selecione todas as imagens com <strong>\u00e1rvores</strong>.";
                    break;
                case "/m/08t9c_":
                    e += "Selecione todas as imagens com <strong>relva</strong>.";
                    break;
                case "/m/0gqbt":
                    e += "Selecione todas as imagens com <strong>arbustos</strong>.";
                    break;
                case "/m/025_v":
                    e += "Selecione todas as imagens com um <strong>cato</strong>.";
                    break;
                case "/m/0cdl1":
                    e += "Selecione todas as imagens com <strong>palmeiras</strong>";
                    break;
                case "/m/05h0n":
                    e += "Selecione todas as imagens da <strong>natureza</strong>.";
                    break;
                case "/m/0j2kx":
                    e += "Selecione todas as imagens com <strong>cataratas</strong>.";
                    break;
                case "/m/09d_r":
                    e += "Selecione todas as imagens com <strong>montanhas</strong>.";
                    break;
                case "/m/03ktm1":
                    e += "Selecione todas as imagens de <strong>corpos de \u00e1gua</strong>, como lagos ou oceanos.";
                    break;
                case "/m/06cnp":
                    e += "Selecione todas as imagens com <strong>rios</strong>.";
                    break;
                case "/m/0b3yr":
                    e += "Selecione todas as imagens com <strong>praias</strong>.";
                    break;
                case "/m/06m_p":
                    e += "Selecione todas as imagens do <strong>sol</strong>.";
                    break;
                case "/m/04wv_":
                    e += "Selecione todas as imagens com <strong>a Lua</strong>.";
                    break;
                case "/m/01bqvp":
                    e += "Selecione todas as imagens do <strong>c\u00e9u</strong>.";
                    break;
                case "/m/07yv9":
                    e += "Selecione todas as imagens com <strong>ve\u00edculos</strong>.";
                    break;
                case "/m/0k4j":
                    e += "Selecione todas as imagens com <strong>carros</strong>";
                    break;
                case "/m/0199g":
                    e += "Selecione todas as imagens com <strong>bicicletas</strong>";
                    break;
                case "/m/04_sv":
                    e += "Selecione todas as imagens com <strong>motas</strong>";
                    break;
                case "/m/0cvq3":
                    e += "Selecione todas as imagens com <strong>cami\u00f5es de caixa aberta</strong>";
                    break;
                case "/m/0fkwjg":
                    e += "Selecione todas as imagens com <strong>cami\u00f5es comerciais</strong>";
                    break;
                case "/m/019jd":
                    e += "Selecione todas as imagens com <strong>barcos</strong>";
                    break;
                case "/m/0cmf2":
                    e += "Selecione todas as imagens com <strong>avi\u00f5es</strong>";
                    break;
                case "/m/01786t":
                    e += "Selecione todas as imagens com um <strong>triciclo</strong>";
                    break;
                case "/m/06_fw":
                    e += "Selecione todas as imagens com um <strong>skate</strong>";
                    break;
                case "/m/019w40":
                    e += "Selecione todas as imagens com <strong>pranchas de surf</strong>";
                    break;
                case "/m/04fdw":
                    e += "Selecione todas as imagens com <strong>caiaques</strong>";
                    break;
                case "/m/03ylns":
                    e += "Selecione todas as imagens com <strong>carrinhos de beb\u00e9</strong>";
                    break;
                case "/m/0qmmr":
                    e += "Selecione todas as imagens com <strong>cadeiras de rodas</strong>";
                    break;
                case "/m/09vl64":
                    e += "Selecione todas as imagens com um <strong>atrelado para bicicleta</strong>.";
                    break;
                case "/m/01lcw4":
                    e += "Selecione todas as imagens com <strong>limusinas</strong>.";
                    break;
                case "/m/0pg52":
                    e += "Selecione todas as imagens com <strong>t\u00e1xis</strong>.";
                    break;
                case "/m/02yvhj":
                    e += "Selecione todas as imagens com um <strong>autocarro escolar</strong>.";
                    break;
                case "/m/01bjv":
                    e += "Selecione todas as imagens com um <strong>autocarro</strong>.";
                    break;
                case "/m/07jdr":
                    e += "Selecione todas as imagens com <strong>comboios</strong>.";
                    break;
                case "/m/01lgkm":
                    e += "Selecione todas as imagens com uma <strong>caravana</strong>.";
                    break;
                case "m/0323sq":
                    e += "Selecione todas as imagens com um <strong>carrinho de golfe</strong>.";
                    break;
                case "/m/02gx17":
                    e += "Selecione todas as imagens com um <strong>ve\u00edculo de constru\u00e7\u00e3o</strong>.";
                    break;
                case "/m/0b_rs":
                    e += "Selecione todas as imagens com uma <strong>piscina</strong>";
                    break;
                case "/m/01h_1n":
                    e += "Selecione todas as imagens com um <strong>recreio</strong>";
                    break;
                case "/m/010jjr":
                    e += "Selecione todas as imagens com um <strong>parque de divers\u00f5es</strong>";
                    break;
                case "/m/01wt5r":
                    e +=
                        "Selecione todas as imagens com um <strong>parque aqu\u00e1tico</strong>";
                    break;
                case "pool_indoor":
                    e += "Selecione todas as imagens com uma <strong>piscina interior</strong>.";
                    break;
                case "pool_outdoor":
                    e += "Selecione todas as imagens com uma <strong>piscina exterior</strong>.";
                    break;
                case "/m/065h6l":
                    e += "Selecione todas as imagens com uma <strong>banheira de \u00e1gua quente</strong>.";
                    break;
                case "/m/0hnnb":
                    e += "Selecione todas as imagens com um <strong>guarda-sol</strong>.";
                    break;
                case "/m/056zd5":
                    e +=
                        "Selecione todas as imagens com <strong>espregui\u00e7adeiras</strong>.";
                    break;
                case "/m/04p0xr":
                    e += "Selecione todas as imagens com uma <strong>mesa de bilhar</strong>.";
                    break;
                case "/m/02p8qh":
                    e += "Selecione todas as imagens com um <strong>p\u00e1tio</strong>.";
                    break;
                case "/m/07gcy":
                    e += "Selecione todas as imagens com um <strong>campo de t\u00e9nis</strong>.";
                    break;
                case "/m/019cfy":
                    e += "Selecione todas as imagens com um <strong>est\u00e1dio</strong>.";
                    break;
                case "/m/03d2wd":
                    e += "Selecione todas as imagens com uma <strong>sala de jantar</strong>.";
                    break;
                case "/m/039l3v":
                    e += "Selecione todas as imagens com um <strong>audit\u00f3rio</strong>.";
                    break;
                case "/m/07cwnp":
                    e += "Selecione todas as imagens com <strong>mesas de piquenique</strong>.";
                    break;
                case "/m/0c06p":
                    e += "Selecione todas as imagens com <strong>velas</strong>.";
                    break;
                case "/m/06vwgw":
                    e += "Selecione todas as imagens com uma <strong>cadeira alta</strong>.";
                    break;
                case "/m/01m3v":
                    e += "Selecione todas as imagens com <strong>computadores</strong>.";
                    break;
                case "/m/07c52":
                    e += "Selecione todas as imagens com <strong>televis\u00f5es</strong>.";
                    break;
                case "/m/07cx4":
                    e += "Selecione todas as imagens com <strong>telefones</strong>.";
                    break;
                case "/m/0n5v01m":
                    e += "Selecione todas as imagens com <strong>malas</strong>.";
                    break;
                case "/m/0bt_c3":
                    e += "Selecione todas as imagens com <strong>livros</strong>.";
                    break;
                case "/m/06rrc":
                    e += "Selecione todas as imagens com <strong>sapatos</strong>.";
                    break;
                case "/m/0404d":
                    e += "Selecione todas as imagens com <strong>joias</strong>.";
                    break;
                case "/m/0dv5r":
                    e += "Selecione todas as imagens com <strong>c\u00e2maras</strong>.";
                    break;
                case "/m/0c_jw":
                    e += "Selecione todas as imagens com <strong>m\u00f3veis</strong>.";
                    break;
                case "/m/01j51":
                    e += "Selecione todas as imagens com <strong>bal\u00f5es</strong>.";
                    break;
                case "/m/05r5c":
                    e += "Selecione todas as imagens com <strong>pianos</strong>.";
                    break;
                case "/m/01n4qj":
                    e += "Selecione todas as imagens com <strong>camisas</strong>.";
                    break;
                case "/m/02crq1":
                    e += "Selecione todas as imagens com <strong>sof\u00e1s</strong>.";
                    break;
                case "/m/03ssj5":
                    e += "Selecione todas as imagens com <strong>camas</strong>.";
                    break;
                case "/m/01y9k5":
                    e += "Selecione todas as imagens com <strong>secret\u00e1rias</strong>.";
                    break;
                case "/m/01mzpv":
                ...
                case "/m/04bcr3":
                    ...
                    break;
                case "/m/09j2d":
                    e += "Selecione todas as imagens com <strong>roupa</strong>.";
                    break;
                case "/m/01xygc":
                    e += "Selecione todas as imagens com <strong>casacos</strong>.";
                    break;
                case "/m/07mhn":
                    e +=
                        "Selecione todas as imagens com <strong>cal\u00e7as</strong>.";
                    break;
                case "/m/01xyhv":
                    e += "Selecione todas as imagens com <strong>fatos</strong>.";
                    break;
                case "/m/0342h":
                ...
                case "/m/03ldnb":
                    ...
                    break;
                default:
                    e = a.Rh ? e + ("Select all images with <strong>" + Ag(a.Rh) + "</strong>.") : e + "Selecione todas as imagens abaixo que correspondam \u00e0 imagem da direita."
            }
            a =
                R(e);
            b += c + Ag(a) + '</div><div class="rc-imageselect-clear"></div></div><div style="display:none" class="rc-imageselect-report-instructions">Selecionar imagens a denunciar</div></div><div class="rc-imageselect-challenge"><div id="rc-imageselect-target" class="rc-imageselect-target" dir="ltr"></div><div class="rc-imageselect-incorrect-response" style="display:none">S\u00e3o necess\u00e1rias v\u00e1rias solu\u00e7\u00f5es corretas, pelo que ter\u00e1 de resolver mais.</div><div class="rc-imageselect-error-select-one" style="display:none">Selecione todas as imagens correspondentes.</div><div class="rc-imageselect-error-select-more" style="display:none">Selecione todas as imagens correspondentes.</div></div>';
            return R(b)
        },
        pn = function(a) {
        ...
        qn = function() {
            return R('Selecione todas as imagens que contenham o objeto descrito no texto ou na imagem presente na parte superior da IU. Em seguida, clique em Confirmar. Para obter um novo desafio, clique no \u00edcone para atualizar. <a href="https://support.google.com/recaptcha" target="_blank">Saiba mais.</a>')
        };
    var Z = function() {
        var a = rn(this);
